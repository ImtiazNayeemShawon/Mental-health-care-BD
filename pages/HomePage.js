      ...
      <div className="mx-10 ">
        <div className="grid grid-cols-2  mt-10 justify-between max-sm:grid-cols-1">
          ...
          <div className="mt-20 max-sm:mt-4 max-sm:text-center">
            <h1 className=" text-4xl  intro max-sm:text-center">
              Take care of your{" "}
            </h1>
            <h1 className="font-bold text-7xl my-5 head max-sm:text-4xl">
              Mental health{" "}
            </h1>
            <div className="h-2 w-20 rounded-lg line my-10 opacity-60"></div>
            ...
            <div className="max-sm:justify-between max-sm:flex">
              <button className="line px-10 py-3 rounded-2xl text-gray-50 font-bold mt-10 hover:bg-white duration-200 hover:text-gray-500 ">
                Explore
              </button>
              <button className=" px-10 py-3 rounded-2xl text-gray-500 shadow-sm bg-white ml-20 font-bold mt-10  hover:bg-gray-500 duration-200 hover:text-white max-sm:ml-0 ">
                About us
              </button>
            </div>
          </div>
